    ...
    return (
        <div className={cn("flex-col", "lg:h-[calc(100vh-10rem)] flex lg:flex-row items-center justify-evenly")}>
            <div className="space-y-8 lg:max-w-[60%] mt-24 lg:mt-0">
                ...
                <span className='text-[#444444]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi, optio sit voluptas magni dolorem nostrum, quisquam nemo pariatur magnam, veniam officia. Rerum incidunt iusto repellendus necessitatibus porro perspiciatis itaque quam?</span>
